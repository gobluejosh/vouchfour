    ...
    <div style={{ minHeight: "100vh", background: "#E8E4DF", fontFamily: FONT, display: "flex", justifyContent: "center" }}>
      <div style={{
        ...
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          {isChecking ? (
            <>
              <div style={{ height: 28, width: "60%", borderRadius: 6, marginBottom: 10, background: "linear-gradient(90deg, #f0ede9 25%, #e8e4df 50%, #f0ede9 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.2s infinite" }} />
              <div style={{ height: 16, width: "85%", borderRadius: 6, marginBottom: 28, background: "linear-gradient(90deg, #f0ede9 25%, #e8e4df 50%, #f0ede9 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.2s 0.1s infinite" }} />
